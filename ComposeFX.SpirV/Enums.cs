namespace ComposeFX.SpirV
{
	...
	{
		public const uint SPV_VERSION = 0x10300;
	...
	public enum ImageOperandsMask : uint
	{
		MaskNone = 0,
		Bias = 0x00000001,
		Lod = 0x00000002,
	...
	public enum MemorySemanticsShift : uint
	{
		Acquire = 1,
		Release = 2,
		AcquireRelease = 3,
	...
	public enum MemorySemanticsMask : uint
	{
		MaskNone = 0,
		Acquire = 0x00000002,
		Release = 0x00000004,
	...
	public enum MemoryAccessShift : uint
	{
		Volatile = 0,
		Aligned = 1,
		Nontemporal = 2,
	...
	public enum MemoryAccessMask : uint
	{
		MaskNone = 0,
		Volatile = 0x00000001,
		Aligned = 0x00000002,
	...
	public enum KernelProfilingInfoShift : uint
	{
		CmdExecTime = 0,
		Max = 0x7fffffff,
	}

	public enum KernelProfilingInfoMask : uint
	{
		MaskNone = 0,
