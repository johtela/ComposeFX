namespace ComposeFX.Maths
{
	...
	[GLType ("ivec2")]
	[CLType ("int2")]
    public readonly struct Vec2i : IVec<Vec2i, int>
    { 
		private static readonly Vec2i _zero = new Vec2i ();
		private static readonly Vec2i _one = new Vec2i (1);
		...
		/// </summary>
		public static ref readonly Vec2i Zero => ref _zero;
		public static ref readonly Vec2i One => ref _one;
		...
		/// </summary>
		public Vec2i FromArray (params int[] components)
		{	
			return new Vec2i (components[0], components[1]);
		}
		...
		public Vec2i Add (in Vec2i other)
		{
		...
		[GLBinaryOperator ("{0} - {1}")]
		[CLBinaryOperator ("{0} - {1}")]
		public Vec2i Subtract (in Vec2i other)
		{
			return new Vec2i (X - other.X, Y - other.Y);
		}
		...
		[GLBinaryOperator ("{0} * {1}")]
		[CLBinaryOperator ("{0} * {1}")]
		public Vec2i Multiply (in Vec2i other)
		{
			return new Vec2i (X * other.X, Y * other.Y);
		}
		...
		[GLBinaryOperator ("{0} / {1}")]
		[CLBinaryOperator ("{0} / {1}")]
		public Vec2i Divide (in Vec2i other)
		{
			return new Vec2i (X / other.X, Y / other.Y);
		}
		...
		[GLUnaryOperator ("-{0}")]
		[CLUnaryOperator ("-{0}")]
        public static Vec2i operator - (in Vec2i vec)
        {
            return vec.Invert ();
        }
		...
		[GLBinaryOperator ("{0} * {1}")]
		[CLBinaryOperator ("{0} * {1}")]
        public static Vec2i operator * (int scalar, in Vec2i vec)
        {
		...
		[GLBinaryOperator ("{0} * {1}")]
		[CLBinaryOperator ("{0} * {1}")]
        public static Vec2i operator * (in Vec2i vec, int scalar)
        {
            return vec.Multiply (scalar);
        }
		...
		[GLBinaryOperator ("{0} * {1}")]
		[CLBinaryOperator ("{0} * {1}")]
        public static Vec2i operator * (in Vec2i vec, in Vec2i scale)
        {
